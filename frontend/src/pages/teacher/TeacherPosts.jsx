...
function TeacherPosts() {
  ...
  async function fetchPosts() {
    ...
    const redirectLink = "teacher/posts"
  ...
  function isInPost(interested_teachers) {
    return interested_teachers.some(st => st._id === user._id);
  }
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {userPosts.map((post) => (
            <PostCard
              ...
              handleJoin={null}
              show_leave_button={!doesOwnPost(post.owner_id._id) && isInPost(post.interested_teachers)}
